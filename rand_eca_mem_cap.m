function rand_nums = rand_eca_mem_cap(rows, columns, upper_memory_limit)    
    % Like rand_eca, but chunks over ECA based on upper_memory_limit
    ...
    [num_chunks, n_iterations_per_chunk, decimal_nums_per_chunk] = compute_chunks(n, bits_per_number, length(seed), upper_memory_limit*bits_per_number);
